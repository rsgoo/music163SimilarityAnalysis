<?php
  ...
  $listUrl1 = $songList->Analysis("http://music.163.com/#/playlist?id=20118684");
  $listUrl2 = $songList->Analysis("http://music.163.com/#/playlist?id=70674412");
    ...
    <div class="div2 marginTop20">
      ...
      <div class="progress height25">
        ...
        style='width: <?php echo "$simiPro"; ?>'>
          <span class="pull-left  height25"><?php echo $simiDis; ?></span>
        </div>
      </div>
    </div>
    <div class="div3 col-sm-5">
      <h4>共同音乐列表<small style="conlor:">&nbsp;(注：如无法播放可能是因为版权不允许)</small></h4>
      <?php
